...
public class CalculatorTest {
	...
	Calculator calc; //Allows calc to be used in test methods
	
	
	//Creates a new Calculator before each test
	@Before
	public void setup() {
		calc = new Calculator();
	...
	*/
	...
	@Test
	public void test_Wrapped_Object() {
	...
	@Test
	public void test_calculator_for_null() {
